...
public class VendedorTest {
	...
	private static final String CODIGO_DEL_PRODUCTO_CON_TRES_VOCALES = "AEI001";
	private static final String NOMBRE_DEL_CLIENTE = "Rene";
	...
	public void generarGarantiaTest() {
		...
		// act
		vendedor.generarGarantia(producto.getCodigo(), NOMBRE_DEL_CLIENTE);
	...
	public void productoYaTieneGarantiaTest() {
		...
		// act
		vendedor.generarGarantia(producto.getCodigo(), producto.getNombre());
		try {
	...
	public void codigoDelProductoConTresVocalesTest() {
		
		Producto producto = new ProductoTestDataBuilder().conCodigo(CODIGO_DEL_PRODUCTO_CON_TRES_VOCALES).build();
